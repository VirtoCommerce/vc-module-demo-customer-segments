...
namespace VirtoCommerce.DemoCustomerSegmentsModule.Web
{
    public class Module : IModule
    {
        ...
        public void Initialize(IServiceCollection serviceCollection)
        {
            ...
            serviceCollection.AddDbContext<VirtoCommerceDemoCustomerSegmentsModuleDbContext>(options => options.UseSqlServer(connectionString));
        }
        ...
        public void PostInitialize(IApplicationBuilder appBuilder)
        {
            ...
            {
                using (var dbContext = serviceScope.ServiceProvider.GetRequiredService<VirtoCommerceDemoCustomerSegmentsModuleDbContext>())
                {
